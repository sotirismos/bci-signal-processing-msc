...
Dist_Score = sum(Dmatrix); subplot(2,2,4), stem(Dist_Score,'o-k','markerfacecolor','r'), grid, xlim([1 Ntrials])
...
% Selects the last six entries from sorted_list in descending order
